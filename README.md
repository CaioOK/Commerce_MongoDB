...
## ℹ️ Sobre o projeto
Este foi um projeto do módulo de Back-End da [Trybe](https://www.betrybe.com/), onde colocamos em prática conhecimentos adquiridos sobre banco de dados NoSQL, utilizando o Sistema de Gerenciamento de Banco de Dados [MongoDB](https://www.mongodb.com/). A ideia é trabalhar com o banco de dados commerce, que contém dados do cardápio do McDonald's, como ingredientes, valores nutricionais e dados fictícios de vendas. A seguir há uma lista das habilidades praticadas neste projeto:
